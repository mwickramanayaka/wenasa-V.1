            ...
            <div class="modal-content">
                ...
                <form method="POST" id="new_customer">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label small_font" for="new_customer_company_name">Company Name</label>
                            <input type="text" class="form-control" id="new_customer_company_name"
                                name="new_customer_company_name" />
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label small_font" for="new_customer_registration_number">Registration
                                Number</label>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label small_font" for="new_customer_tel1">Telephone (Primary) <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="new_customer_tel1" name="new_customer_tel1" />
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label small_font" for="new_customer_tel2">Telephone (Secondary)</label>
                            <input type="text" class="form-control" id="new_customer_tel2" name="new_customer_tel2" />
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label small_font" for="new_customer_email">Email</label>
                            <input type="email" class="form-control" id="new_customer_email" name="new_customer_email" />
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label small_font" for="new_customer_bank_details">Bank Details</label>
                            <textarea id="new_customer_bank_details" name="new_customer_bank_details" class="form-control"
                                rows="3"></textarea>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" id="update_customer_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" for="update_customer_name">Supplier Name <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="update_customer_name" name="new_customer_name"
                                readonly />
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label" for="update_customer_company_name">Company Name</label>
                            <input type="text" class="form-control" id="update_customer_company_name"
                                name="new_customer_company_name" />
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label" for="update_customer_registration_number">Registration
                                Number</label>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" for="update_customer_city">City <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="update_customer_city" name="new_customer_city" />
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label" for="update_customer_tel1">Telephone (Primary) <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="update_customer_tel1" name="new_customer_tel1" />
                        </div>

                        <div class="form-group mb-3">
                            <label class="form-label" for="update_customer_tel2">Telephone (Secondary)</label>
                            <input type="text" class="form-control" id="update_customer_tel2" name="new_customer_tel2" />
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea id="update_customer_bank_details" name="new_customer_bank_details"
